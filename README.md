...
This repo keeps the reusable GEE extraction code, run configuration, and Colab runner. Product-search notes and dataset decisions live in `global-river-chem/data-documentation`; this repo is for running those decisions.

## Quick Links

- Colab runner: [run-gee-spatial-extractions.ipynb](https://colab.research.google.com/github/global-river-chem/data-workflow_spatial/blob/main/notebooks/run-gee-spatial-extractions.ipynb)
...
- `src/gee_spatial/`: reusable Python helpers for GEE extraction, export, and checks.
- `scripts/`: R and Python utilities for watershed prep, config checks, and run planning.
...
5. Check task counts before launching a run.
